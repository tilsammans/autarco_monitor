...
-- The peak power and currency setting are retrieved from the inverter. 
...
function QuickApp:valuesOverview() -- Get the values from json file Overview
  ...
  data.solarPower = string.format("%.3f",self:solarPower(tonumber(data.currentPower), tonumber(solarM2)))
  data.lastDayData = string.format("%.3f",jsonTable.overview.lastDayData.energy/1000)
  data.lastMonthData = string.format("%.3f",jsonTable.overview.lastMonthData.energy/1000)
...
function QuickApp:simData() -- Simulate SolarEdge Monitor
  ...
  apiResult = '{"overview":{"lastUpdateTime":"2021-08-12 13:46:04","lifeTimeData":{"energy":7827878.0,"revenue":1728.5211},"lastYearData":{"energy":573242.0},"lastMonthData":{"energy":113386.0},"lastDayData":{"energy":7373.0},"currentPower":{"power":134.73499},"measuredBy":"INVERTER"}}'
...
function QuickApp:setupChildDevices()
  ...
  if #cdevs == 0 then -- If no Child Devices, create them
      local initChildData = { 
        ...
        {className="lastDayData", name="Lastday", type="com.fibaro.energyMeter", value=0},
